...
export function StudioPage({ notify, state, onboarding = null, resumeOnboarding = async () => undefined }: { notify(message: string): void; state: PollingState<StudioPayload>; onboarding?: OnboardingSnapshot | null; resumeOnboarding?(): Promise<void> }) {
