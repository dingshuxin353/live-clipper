...
export function ClipsPage() {
  ...
  return <section className="page clips-page">
    <PageHeading eyebrow="自动生产结果" title="成片" description="查看 AI 审阅后的成片、无片结论和需要继续处理的问题。打开结果后才会标记为已查看。" actions={<button className="button" onClick={() => void load()}>刷新</button>} />
