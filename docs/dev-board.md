...
| 车道 | Spec | 文件集合 | 依赖 | 状态 |
|---|---|---|---|---|
| 0.3.1-misans-default-font | `specs/2026-07-24-0.3.1-misans-default-font.md` | Phase 1 字体资产与许可；Phase 2 CSS 与打包接线 | 以 Spec 头部精确基线为准 | Phase 1 `aa28794` 已通过独立验收；下载基础设施已合入，Phase 2 门禁满足 |
...
| 顺序 | 车道 | Spec | 依赖 | 状态 |
|---:|---|---|---|---|
| 1 | 0.3.1-misans-default-font Phase 2 | 同一字体 Spec 与 lane | 字体 Phase 1 独立验收通过；下载基础设施已合入 | 门禁满足，准备在原车道同步最新 master 后实施 |
